# This path points to the project's repo inside the local file system, and is inferred automatically by using dbutils
path = dbutils.notebook.entry_point.getDbutils().notebook().getContext().notebookPath().get()
PROJECT_PATH = 'file:' + path[:path.find('Follow-The-Leaders')] + 'Follow-The-Leaders/'

# TODO - Change this path to the appropriate location in your databricks environment!
# This path should point to a directory where you want to store data in the dbfs, hence the '/dbfs' prefix:
PROJECT_DATA_DIR = '/dbfs/user_data/g44/project_data'


# These are all nested inside of the above two paths and can be safely ignored
LOCAL_DATA = PROJECT_PATH + '/local_data'

SCRAPED_DATA_DIR = PROJECT_DATA_DIR + '/scraped_data'

TARGET_USERS = PROJECT_DATA_DIR + '/target_users'


# These are convenient constants that took too much space in the notebooks
