...
# MAGIC %md
# MAGIC We can see that topic 1 is the topic that contains the more relevant documents for our query, 
# MAGIC because it contains the query terms and thus is more appropriate to present to the LLM in the next stage.
...
# MAGIC %md
# MAGIC Although it's harder to tell with this query, topic 1 is still the most appropriate topic to give to the LLM 
# MAGIC because at least it resembles the overall term frequency.
